...
<div id="mainpage">
    <div id='leftcontainer'>
        ...
        <p>
            The official RetroAchievements.org emulators are all Windows-based. For other operating systems - such as Linux (which includes <a href="https://retropie.org.uk/">RetroPie</a>, <a
                href="https://www.recalbox.com">Recalbox</a> and <a href="https://www.lakka.tv">lakka</a>), Mac, Android, PlayStation Vita, Wii U, and, of course, even Windows - you can use RetroArch:
            <br>
            ...
            <br>
            <br>
            <strong>Note: although we have some members contributing in the RetroArch front, keep in mind that RetroArch is maintained by <a href="https://github.com/libretro/">another
                    team</a>.</strong>
        </p>

        <br/>
        <h3>Source Code</h3>
        <p>All RetroAchievements emulators are released as free software. Licensing terms for usage and distribution of derivative works may vary depending on the emulator. Please consult the license
            information of each one for more details.
            <br>
