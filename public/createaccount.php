            ...
            <form method=post action="requestcreateuser.php">
                <table class='paddedtable'>
                    ...
                    <tr>
                        ...
                        <td>
                            <div><input type="text" class="inputtext" id="loginbox" name='u' size='25'/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label"><label for="e">Your Email:</label></td>
                        <td>
                            <div><input type="text" class="inputtext" id="loginbox" name='e' size='50'/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label"><label for="f">Re-enter Email:</label></td>
                        <td>
                            <div><input type="text" class="inputtext" id="loginbox" name='f' size='50'/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label"><label for="p">New Password:</label></td>
                        <td>
                            <div><input type="password" class="inputtext" id="loginbox" name='p' size='25' value=""/></div>
                        </td>
                    </tr>
                    <tr>
