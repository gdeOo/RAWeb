...
<head>
    ...
    } elseif ($ticketID !== 0 && $ticketData) {
        RenderFBMetaData(
            $pageTitle,
            "tickets",
            "/Badge/" . $ticketData['BadgeName'] . ".png",
            "/achievement/" . $ticketData['AchievementID'],
            "Tickets for '" . $ticketData['AchievementTitle'] . "' - " . $ticketData['GameTitle'] . " (" . $ticketData['ConsoleName'] . ")"
        );
    }
